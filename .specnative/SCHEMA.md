...
En el perfil `team`, estos tres archivos y el manifiesto de comandos deben
existir junto con `specnative_mcp.py`. El entorno `.venv/` es generado y no se
versiona.
...
### Perfil de equipo aplicado en WebSpider

WebSpider usa el perfil `team`: conserva el contexto del proyecto, añade
workflows de planificación y revisión, documenta CI/CD y expone el MCP local
para los tres agentes soportados. Los archivos generados de comandos son
adaptadores; `.specnative/commands.json` es la única fuente de verdad.
